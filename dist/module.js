...
// Module
exports.push([module.i, ".p-table {\n  padding: 1rem;\n  border-spacing: 0;\n  border: 1px solid #000;\n  width: 100%;\n  table-layout: fixed; }\n\n.p-table thead {\n  background: #474b4b;\n  color: #fff; }\n\n.p-table th {\n  width: auto;\n  text-align: center; }\n\n.p-table th,\ntd {\n  margin: 0;\n  padding: 0.5rem;\n  border-bottom: 1px solid #000;\n  border-right: 1px solid #000; }\n\n.p-table th:first-child {\n  width: 15%; }\n\n.p-table tr:last-child td {\n  border-bottom: 0; }\n\n.p-table tbody tr:nth-child(even) {\n  background: #f3f3f3; }\n\n.p-table tbody {\n  text-align: right; }\n\n.p-table th:last-child,\ntd:last-child {\n  border-right: 0; }\n", "",{"version":3,"sources":["main.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,iBAAiB;EACjB,sBAAsB;EACtB,WAAW;EACX,mBAAmB,EAAE;;AAEvB;EACE,mBAAmB;EACnB,WAAW,EAAE;;AAEf;EACE,WAAW;EACX,kBAAkB,EAAE;;AAEtB;;EAEE,SAAS;EACT,eAAe;EACf,6BAA6B;EAC7B,4BAA4B,EAAE;;AAEhC;EACE,UAAU,EAAE;;AAEd;EACE,gBAAgB,EAAE;;AAEpB;EACE,mBAAmB,EAAE;;AAEvB;EACE,iBAAiB,EAAE;;AAErB;;EAEE,eAAe,EAAE","file":"main.css","sourcesContent":[".p-table {\n  padding: 1rem;\n  border-spacing: 0;\n  border: 1px solid #000;\n  width: 100%;\n  table-layout: fixed; }\n\n.p-table thead {\n  background: #474b4b;\n  color: #fff; }\n\n.p-table th {\n  width: auto;\n  text-align: center; }\n\n.p-table th,\ntd {\n  margin: 0;\n  padding: 0.5rem;\n  border-bottom: 1px solid #000;\n  border-right: 1px solid #000; }\n\n.p-table th:first-child {\n  width: 15%; }\n\n.p-table tr:last-child td {\n  border-bottom: 0; }\n\n.p-table tbody tr:nth-child(even) {\n  background: #f3f3f3; }\n\n.p-table tbody {\n  text-align: right; }\n\n.p-table th:last-child,\ntd:last-child {\n  border-right: 0; }\n"]}]);
// Exports
...
var MainEditor = function MainEditor(_a) {
  ...
  var options = _a.options,
      onOptionsChange = _a.onOptionsChange; // const onSubmit = () => {
  //   onOptionsChange(input);
  // };

  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["PanelOptionsGroup"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
var Table = function Table() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("table", Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({
    className: "p-table"
  }, getTableProps()), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("thead", null, headerGroups.map(function (headerGroup) {
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("tr", Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, headerGroup.getHeaderGroupProps()), headerGroup.headers.map(function (column) {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("th", Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, column.getHeaderProps()), column.render('Header'));
    }));
  })), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("tbody", Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, getTableBodyProps()), rows.map(function (row, i) {
    prepareRow(row);
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("tr", Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, row.getRowProps()), row.cells.map(function (cell) {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("td", Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, cell.getCellProps()), cell.render('Cell'));
    }));
  })));
};
